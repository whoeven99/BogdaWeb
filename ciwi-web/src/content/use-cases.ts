...
const useCasesEn: UseCaseItem[] = [
  ...
  },
  {
    ...
    productSlug: "spark-analytics-agent",
    category: "Catalog",
    title: "Investigate Shopify Product Catalog & Ad Sync Errors",
    description: "Review Shopify product sync errors and Facebook catalog issues so your team can identify missing fields, price mismatches, and feed problems.",
    heroTitle: "Investigate Shopify Product Catalog & Ad Sync Errors",
    heroDescription:
      "Use Spark to review catalog and product signals alongside ad performance. Identify the records that need attention before deciding how to fix a Facebook catalog error or other paid-ad feed issue.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Troubleshoot Shopify Conversion Tracking with Spark",
    description: "Investigate Shopify conversion tracking issues, verify ad-tracking signals, and review analytics discrepancies with Spark.",
    heroTitle: "Troubleshoot Shopify Conversion Tracking with Spark",
    heroDescription:
      "Use Spark to review Shopify analytics data and tracking status together. Identify the setup or data discrepancy to investigate before treating a change in reported conversions as a real change in sales.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Launch a Localized Shopify Store in a New Market",
    description: "Plan a multilingual storefront launch with the products, navigation, trust content, and terminology your next market needs.",
    heroTitle: "Launch a Localized Shopify Store in a New Market",
    heroDescription:
      "Launch a localized Shopify store by defining the market and language, prioritizing customer-facing content, and reviewing the buying journey before publishing.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "Sync",
    title: "Automatic Translation Sync for Shopify",
    description: "Keep translated Shopify products and storefront content aligned when SKUs, product details, and promotions change.",
    heroTitle: "Automatic Translation Sync for Shopify",
    heroDescription:
      "Use automatic translation sync to send new and changed Shopify content back through the translation workflow. Review important updates before publishing each language.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Keep a Consistent Brand Voice Across Translations",
    description: "Set preferred terminology and review translated product and campaign copy so your brand voice stays consistent across markets.",
    heroTitle: "Keep a Consistent Brand Voice Across Translations",
    heroDescription:
      "Start with the brand terms and product phrases customers see most often. Use glossary control and targeted review to keep translations consistent without forcing identical wording in every language.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "Market Fit",
    title: "Regional Content Localization for Shopify Markets",
    description: "Adapt Shopify storefront wording to regional expectations, buying habits, and terminology instead of reusing one translation everywhere.",
    heroTitle: "Regional Content Localization for Shopify Markets",
    heroDescription:
      "Regional content localization starts with the market's language and shopping context. Review product benefits, promotional wording, and trust information for each audience.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Ecommerce Translation by Product, Collection & Market",
    description: "Prioritize ecommerce translation by product, collection, language, or market to control scope and reduce unnecessary translation work.",
    heroTitle: "Ecommerce Translation by Product, Collection & Market",
    heroDescription:
      "Choose the ecommerce content that matters for the next launch or update. Define a focused translation scope, review the estimated work, and expand coverage as the store needs it.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Localize Shopify Banners, Images & Alt Text",
    description: "Plan visual storefront localization across Shopify banners, image text, and alt text so translated pages communicate a consistent message.",
    heroTitle: "Localize Shopify Banners, Images & Alt Text",
    heroDescription:
      "Review visual content alongside the page copy. Localize text-bearing images and banners, and check image alt text so the storefront's visual and written messages stay aligned.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "SEO",
    title: "SEO Localization for Multilingual Shopify Stores",
    description: "Plan Shopify SEO localization across local search intent, translated metadata, storefront content, and language-version checks.",
    heroTitle: "SEO Localization for Multilingual Shopify Stores",
    heroDescription:
      "Build a multilingual SEO strategy around how customers search in each market. Align translated page content and metadata, then review language coverage and links before publishing.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "Migration",
    title: "Recover Shopify Translation Quality After a Tool Change",
    description: "Review existing translations, protect approved wording, and plan a Shopify translation-tool migration with clear quality checks.",
    heroTitle: "Recover Shopify Translation Quality After a Tool Change",
    heroDescription:
      "Recover Shopify translation quality by checking the content that changed, identifying inconsistent wording, and reviewing high-value translations before a wider rollout.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "Human + AI",
    title: "AI Translation with Human Review for Shopify",
    description: "Combine AI translation with human review in Shopify, prioritizing important content and preparing translations for editorial checks.",
    heroTitle: "AI Translation with Human Review for Shopify",
    heroDescription:
      "Use AI for the first translation pass, then have reviewers check brand wording, product details, and market-specific language before publishing.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Find Missing Translations in Your Shopify Store",
    description: "Detect Shopify localization gaps across product content, themes, FAQs, images, and structured fields before the next market launch.",
    heroTitle: "Find Missing Translations in Your Shopify Store",
    heroDescription:
      "Audit the storefront for missing translated ecommerce content. Prioritize gaps in the product and buying journey, then route the affected content into the translation workflow.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    title: "Scale Shopify Localization with a Small Team",
    description: "Use a repeatable translation workflow to expand international reach while keeping content scope, reviews, and updates manageable.",
    heroTitle: "Scale Shopify Localization with a Small Team",
    heroDescription:
      "Scale international reach with a focused localization workflow. Prioritize markets and content, automate suitable translation work, and reserve review time for high-impact pages.",
    keywordPlayground: {
      title: "Keyword and angle playground",
  ...
  },
  {
    ...
    productSlug: "translator",
    category: "Scale",
    title: "Translation Terminology Management for Shopify",
    description: "Manage translation terminology with a glossary and review workflow that keeps product names and brand language consistent as content grows.",
    heroTitle: "Translation Terminology Management for Shopify",
    heroDescription:
      "Use translation terminology management to define approved product and brand terms. Apply the glossary during translation and review repeated phrases across the storefront as new content is added.",
    keywordPlayground: {
      title: "Keyword and angle playground",
...
export function getUseCases(locale: Locale) {
  return normalizeInternalHrefFields(localizeLanguageSignalFields(locale, locale === "zh-cn" ? useCasesZh : useCasesEn));
}
