  ...
  en: {
    ...
    sections: {
      ...
      productResearch: {
        ...
        ctaLabel: "Browse product research",
  ...
  "zh-cn": {
    ...
    sections: {
      guides: {
        eyebrow: "指南",
        title: "本地化与翻译指南",
        description: "集中整理行业、品牌、B2B 和 Shopify 功能场景相关的本地化指南，适合继续扩展 SEO 落地页。",
        modulesEyebrow: "指南模块",
        modulesTitle: "按模块浏览指南",
        modulesDescription: "先进入和当前搜索意图更接近的指南模块，再往下看对应的精选内容。",
        categoryEyebrow: "本地化指南",
        categoryTitle: "行业、品牌与 B2B 指南",
        categoryDescription: "适合承接类目型本地化搜索需求，覆盖行业内容特点、市场差异和本地化策略。",
        categoryHref: "/guides#localization-guides",
        scenarioEyebrow: "功能场景指南",
      ...
      useCases: {
        eyebrow: "应用场景",
        title: "应用场景方案集",
        description: "围绕产品真实经营场景整理的结构化页面，适合继续扩展为聚合页加详情页的内容体系。",
        ctaLabel: "浏览应用场景",
        ctaHref: "/use-cases",
      },
      helpCenter: {
