export const pagesCopy = {
  ...
  blog: {
    ...
    hero: {
      ...
      directionTitle: "内容方向",
      directionTemplate: "目前已有 {{count}} 篇文章，围绕多语言、本地化和增长方法展开。",
      audienceTitle: "适合谁看",
      audienceText: "适合正在评估翻译与本地化路径、希望通过内容先理解问题的 Shopify 商家和运营团队。",
    },
    media: {
      eyebrow: "Blog media",
      title: "博客首页视觉预留",
  ...
  helpCenter: {
    ...
    hero: {
      ...
      startTitle: "从这里开始",
      startTemplate: "目前已整理出 {{count}} 篇帮助文档，优先覆盖安装配置、翻译流程、术语控制和多市场运营等高频问题。",
      audienceTitle: "适合谁看",
      audienceText: "适合准备开始配置的商家，也适合已经在使用产品、想更快解决具体问题的运营团队。",
    },
    media: {
      eyebrow: "Help media",
      title: "帮助中心首页视觉预留",
    ...
    all: {
      ...
      statsFeaturedTitle: "Featured docs",
      statsFeaturedTemplate: "精选了 {{count}} 篇文档，优先覆盖产品定位、翻译流程、glossary、模型和多币种等高频问题。",
      statsAllTitle: "All docs",
      statsAllTemplate: "站内已纳入 {{count}} 篇帮助文档，方便你按主题继续深入了解具体配置和使用细节。",
    },
    finalCta: {
