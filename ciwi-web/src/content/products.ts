...
export const products: ProductItem[] = [
  {
    slug: "translator",
    name: "AI Translator",
    shortDescription: "面向 Shopify 商家的多语言翻译、本地化和持续同步工具。",
    heroTitle: "不只翻译文本，而是把 Shopify 本地化做成可持续增长能力",
    heroDescription:
      "Ciwi AI Translator 覆盖商品、主题、导航、FAQ、图片和 metafields 等关键内容层，让多语言上线、术语控制和后续更新变得更可控。",
    icon: "/translate.svg",
    ...
    faq: [
      {question: "Ciwi 和普通翻译工具的核心区别是什么？", answer: "Ciwi 重点解决 Shopify 场景下的结构化内容、本地化质量和持续同步问题，而不是只把文本逐段翻译出来。"},
  ...
  },
  {
    ...
    heroDescription: "Bundle Discount 不是单纯把折扣放到页面上，而是帮助商家把套餐逻辑、节省金额和购买理由表达得更清楚。",
  ...
  },
  {
    ...
    heroDescription: "Content AI 用来帮助商家更快生成商品标题、卖点、FAQ 和 SEO 页面草稿，让内容生产更像流程，而不是每次都从空白开始。",
