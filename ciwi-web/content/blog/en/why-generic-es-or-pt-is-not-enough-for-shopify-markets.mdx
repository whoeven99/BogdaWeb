...
<FaqAccordion
  items={[
    {
      question: "Is one generic Spanish locale enough for all Spanish-speaking markets?",
      answer: "Not always. It may work for a lightweight launch, but it is often too weak when markets such as Spain and Mexico need separate SEO signals, storefront behavior, or publishing control.",
    },
    {
      question: "Does the same issue apply to Portuguese?",
      answer: "Yes. Portugal and Brazil often expose the same structural problem: one generic Portuguese layer is not the same as operating distinct regional storefronts.",
    },
    {
      question: "Where does Ciwi AI Translator fit in this model?",
      answer: "After the market split and regional language exposure are set correctly, Ciwi helps manage publishing and compatibility for that language layer.",
    },
  ]}
/>
