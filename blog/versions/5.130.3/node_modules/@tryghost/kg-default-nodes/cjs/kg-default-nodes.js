 ...
 */
function generateDecoratorNode({nodeType, properties = [], defaultRenderFn, version = 1, hasVisibility = false}) {
...
function emailCardTemplate$1({node}, options = {}) {
    if (options.feature?.emailCustomization || options.feature?.emailCustomizationAlpha) {
        return (
            html`
...
function renderToggleNode(node, options = {}) {
    ...
    const htmlString = options.target === 'email'
        ? emailCardTemplate$1({node}, options)
        : cardTemplate$4({node});
...
function renderProductNode(node, options = {}) {
    ...
    const htmlString = options.target === 'email'
        ...
        : cardTemplate$1({data: templateData, feature: options.feature});
